...
class TreesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tree" do
    assert_difference("Tree.count") do
      post trees_url, params: { tree: { ig: @tree.ig, name: @tree.name, style: @tree.style, user_id: @tree.user_id, x: @tree.x, ytb: @tree.ytb } }
    end
  ...
  test "should update tree" do
    patch tree_url(@tree), params: { tree: { ig: @tree.ig, name: @tree.name, style: @tree.style, user_id: @tree.user_id, x: @tree.x, ytb: @tree.ytb } }
